...
const EXTENSION_NAME = "DeadlineDetectorColumn@SONN";
var extension = ExtensionParent.GlobalManager.getExtension(EXTENSION_NAME);

// Implements the functions defined in the experiments section of schema.json.
var DDC = class extends ExtensionCommon.ExtensionAPI {
  onStartup() {
  }
...
function paint(win) {
  win.DDC = {};
  Services.scriptloader.loadSubScript(extension.getURL("customcol.js"), win.DDC);
  win.DDC.DDCHeaderView.init(win);
}

function unpaint(win) {
  win.DDC.DDCHeaderView.destroy();
  delete win.DDC;
}
